...
using HaylandMontalvo_EjercicioCF.Data;
using HaylandMontalvo_EjercicioCF.Models;

namespace HaylandMontalvo_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly HaylandMontalvo_EjercicioCFContext _context;

        public BurgersController(HaylandMontalvo_EjercicioCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'HaylandMontalvo_EjercicioCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HaylandMontalvo_EjercicioCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
